        ...
        <div class="mb-4">
            ...
            <div>
                <table class="table border-collapse table-auto w-full text-sm mt-2 rounded-lg overflow-hidden">
                    ...
                    <tr v-for="param in paramsData" :key="param.id">
                        ...
                        <td class="border-b border-slate-100 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">
                            ...
                            <svg @click.prevent="deleteParam(param)" xmlns="http://www.w3.org/2000/svg"
                                 fill="none"
    ...
    methods: {
        deleteParam(param) {
            axios.delete(route('admin.params.destroy', param.id))
                .then(response => {
                    this.params = this.filter(paramsData => paramsData.id !== param.id);
                })
        }
    }
}
